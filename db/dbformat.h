...
namespace config {
static const unsigned kNumLevels = 3;   //5.8 设为2个分区，加上L0，其实就3层

//3.26  将分区数设为静态变量
static const unsigned kNumPars = 10;

//5.8 设定第二层分区数 
static const unsigned kNum2Pars = 100;
...
// point, but don't.
static const unsigned kL0_SlowdownWritesTrigger = 60;  //5.3这个条件约束L0文件有多少时减缓写

// Maximum number of level-0 files.  We could stop writes at this point, but
// don't.
static const unsigned kL0_StopWritesTrigger = 12;  //并没有限制L0层文件的数量
